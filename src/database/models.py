...
class CreditTransaction(Model):
    ...
    transaction_id = Column(Integer, unique=True, primary_key=True, index=True, nullable=False)
...
class CustomerApplication(Model):
    ...
    customer_id = Column(Integer, unique=True, primary_key=True, index=True, nullable=False)
